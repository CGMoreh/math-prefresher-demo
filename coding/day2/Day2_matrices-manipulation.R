...
#Download the datasets "usc2010_001percent.csv" and "data/input/Nunn_Wantchekon_AER_2011.dta" from the prefresher github folder https://github.com/IQSS/prefresher/tree/master/data/input

cen10 <- read_csv("/Users/mariaballesteros/Downloads/usc2010_001percent.csv")
head(cen10)
...
cen10$test_cali <-cen10$state == "California"

ca_subset_tidy <- cen10 %>% subset(state == "California")
...
ca_subset_age_race_tidy <- cen10 %>% filter(state == "California") %>% select(race, age)
...
s1 <- cen10[(cen10$age > 30 & cen10$age < 70) & !(cen10$state == "California" & cen10$age > 45), ]
...
nunn_full <- read_dta("/Users/mariaballesteros/Downloads/Nunn_Wantchekon_AER_2011.dta")
...
write_dta(sample, "/Users/mariaballesteros/Downloads/Nunn_Wantchekon_sample.dta")

                                                
nunn <- read_dta("/Users/mariaballesteros/Downloads//Nunn_Wantchekon_sample.dta")
nunn
...
system.time(lapply(50000, colMeans(Xmat)))
system.time(lapply(50000, colMeans(Xdf)))
